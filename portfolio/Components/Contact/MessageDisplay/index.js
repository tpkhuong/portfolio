  ...
  return (
    <div className={DisplayStyles[`message-display-container`]}>
      <p className={DisplayStyles[`code-line`]} data-linenumber="1">
        <span
          className={`${DisplayStyles[`const-obj-prop`]} ${
        ...
        <span
          className={`${DisplayStyles[`variable`]} ${
            DisplayStyles[`margin-inline-end`]
          }`}
        >
          button
        ...
        <span className={DisplayStyles[`selector-property-content`]}>
          "#sendBtn"
        </span>
        <span className={DisplayStyles[`parentheses`]}>)</span>
        <span>;</span>
      ...
      <p
        data-linenumber="2"
        aria-hidden="true"
        className={DisplayStyles[`code-line`]}
      >
      ...
      <p
        className={`${DisplayStyles[`code-line`]} ${
          DisplayStyles[`padding-inline-start-medium`]
        } ${DisplayStyles[`margin-block-start-start`]}`}
        data-linenumber="4"
      >
        ...
        <span
          id="name-content"
          className={DisplayStyles[`selector-property-content`]}
        >
      ...
      <p
        className={`${DisplayStyles[`curly`]} ${DisplayStyles[`code-line`]} ${
          DisplayStyles[`margin-block-start-start`]
        }`}
        data-linenumber="8"
      >
      ...
      <p className={DisplayStyles[`code-line`]} data-linenumber="10">
        ...
        <span
          className={`${DisplayStyles[`parentheses`]} ${
            DisplayStyles[`margin-inline-end`]
          }`}
        >
          )
